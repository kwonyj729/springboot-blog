...
<div class="container">
	...
	<form form="/user/profile" method="POST" encType="multipart/form-data">
		...
		<div class="form-group">
			<label for="username">유저네임 : </label> <input type="text" class="form-control" placeholder="Enter username" name="username" value="ssar" readonly="readonly" />
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<input type="file" class="form-control" name="email" value="myphoto.jpg" />
		</div>
