...
<div class="container">
	<div class="card">
		...
		<div class="card-footer">
			<button id="post--update--submit" class="btn btn-warning">글수정</button>
			<button id="post--delete--submit" class="btn btn-danger">글삭제</button>
			<a href="/post" class="btn btn-success">글목록</a>
		</div>
	</div>
